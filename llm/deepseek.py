...
def get_system_prompt():
    ...
    system_prompt = (
        ...
        "the cells and expressions to retain will be enclosed in <var></var> tags. If the tag `<auto />` is enclosed "
        "in the <var></var> tags, you should automatically determine the important variables and expressions to keep. "
